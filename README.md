# React Assigmnent Project Select Your Dream Cricket Squad!
...
1. **Select A Player**: Player Add if coin not sufficient for player market price then shows toast message else add the player. Then coin substract to player price
2. **Delete A Player**: A player reduces from selection pannel then add coin of player price to total coin.
3. **Team of 6**: Only select 6 player. otherwise show a toast message.
